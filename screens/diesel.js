...
export default class Diesel extends React.Component {
  constructor(){
    super();
    this.state = {
           password:'',
  ...
  render() {
    return ( 
      <View style={styles.container}>
       ...
       <Text style={styles.h11}>Diesel Pickup Data Log</Text>
...
<Text style={{color:'grey', marginTop:RH(5), marginLeft:RW(5)}}>Odometer Readings </Text>
  ...
  <TextInput style={styles.textinput}  onChangeText ={odometer=>this.setState({odometer})}   />

  <Text style={{color:'grey', marginTop:RH(5), marginLeft:RW(5)}}>Liters Received</Text>

  <TextInput style={styles.textinput}  onChangeText ={liters=>this.setState({liters})}   />

   <Text style={{color:'grey', marginTop:RH(5), marginLeft:RW(5)}}>Diesel Pickup Destination</Text>
